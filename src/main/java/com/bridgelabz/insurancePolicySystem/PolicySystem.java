...
public class PolicySystem {
    ...
    public static void main(String[] args) {
        ...
        // Adding policies
        system.addPolicy(new Policy("N100", "Sanya", LocalDate.now().plusDays(10)));
        system.addPolicy(new Policy("N101", "Sourav", LocalDate.now().plusDays(16)));
        system.addPolicy(new Policy("N102", "Sakshi", LocalDate.now().minusDays(7))); // Expired
        system.addPolicy(new Policy("N103", "Nikhil", LocalDate.now().plusDays(25)));

        // Display all policies
        system.displayAllPolicies();

        // Retrieve a specific policy
        System.out.println("\nPolicy N101: " + system.getPolicy("N101"));

        // Policies expiring in next 30 days
        System.out.println("\nExpiring Soon Policies: " + system.getExpiringSoonPolicies());

        System.out.println("\nNikhil's Policies: " + system.getPoliciesByHolder("Nikhil"));
